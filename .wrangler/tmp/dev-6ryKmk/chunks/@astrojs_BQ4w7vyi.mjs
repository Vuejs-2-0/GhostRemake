...
import { d as defineComponent, h, c as createSSRApp, r as renderToString } from './@vue_gmVJm0w8.mjs';
...
function createExports(manifest) {
  ...
  const fetch = async (request, env, context) => {
    ...
    await import('../renderers.mjs').then(n => n.j).then((mod) => mod.setGetEnv(createGetEnv(env))).catch(() => {
    });
